...
public class ArenaBuilder {
    ...
    private void initializeGladiatorAttacks(Gladiator gladiator, SingleArrowPool arrowPool) {
        ...
        gladiator.setSwordAttack(new SwordAttack(15, 30, new ArrayList<>()));
        ...
        gladiator.setBowAttack(new BowAttack(10, 3, 200, new ArrayList<>(), arrowPool));
    }
    ...
    protected Gladiator createGladiator() {
        return Gladiator.getInstance(ARENA_WIDTH / 2, ARENA_HEIGHT / 2,16,14,200,3);
    }
}
